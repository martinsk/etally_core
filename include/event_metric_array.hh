...
public:
  ...
  // this should be encapsulated in idx_assigner.hh with the hash as a template arg
  ...
  // this should be counter_arrays insteed of maps, since the idx's are simple end new.
  ...
  static std::unordered_map<counter_idx_t, std::unordered_map<unsigned int,  percentile* > >  percentile_map;
